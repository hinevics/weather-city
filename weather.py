...
class Weather:
    DEFAULT_API_CITY = 'http://api.openweathermap.org/geo/1.0/direct?q={city_name}&limit={limit}&appid={api_key}'
    ...
    def geocoding(self):
        ...
        answer = requests.get(url=DEFAULT_API_CITY.format(city_name=self.city, api_key=))
